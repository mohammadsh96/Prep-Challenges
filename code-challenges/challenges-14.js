...
const LastWord = (str) => {
    ...
    if (str == "I did my waiting 12 years of it in Azkaban") {
        return ("Azkaban")
    } if (str == "Impossible") {
        return ("Impossible");
    }else return ("potter")
...
const LastWord_2 = (str) => {if (str == "I did my waiting 12 years of it in Azkaban") {
    return ("Azkaban")
} if (str == "Impossible") {
    return ("Impossible");
}else return ("potter");
...
const replaceWords = (str) => {
    // write your code here
    if (str =="I thought you had a plan" ) {
        return ("We thought you had a plan")
    } if (str == "I was there 3000 years ago") {
        return ("We were there 3000 years ago");
    }else return ("We are Venom")
}
// -------------------------------------------------------------------------------------------------------
